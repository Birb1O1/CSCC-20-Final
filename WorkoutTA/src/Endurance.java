...
public class Endurance extends JPanel {

    private navigationService nav;

    public Endurance(navigationService nav) {
        this.nav = nav;
        createUI();
    }
    ...
    private void createUI() {
        ...
        JLabel title = new JLabel("Endurance Workouts");
        ...
        // Workout cards
        add(createWorkoutCard("Pull Ups", "Intense", "/Bpullups.png"));
        add(Box.createVerticalStrut(15));
        add(createWorkoutCard("Squats", "Moderate", "/Bsquat.jpg"));
        add(Box.createVerticalStrut(15));
        add(createWorkoutCard("Push Ups", "Beginner", "/Bpushups.png"));
        ...
        unlockButton.addActionListener(e -> {
            JOptionPane.showMessageDialog(this, "Endurance workout selected!");

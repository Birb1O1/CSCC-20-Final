...
public class LoseWeight extends JPanel {
    ...
    private void createUI() {
        ...
        JLabel title = new JLabel("Lose Weight Workouts");
        ...
        // Workout cards
        add(createWorkoutCard("Swimming", "Intense", "/CSwim.png"));
        add(Box.createVerticalStrut(15));
        add(createWorkoutCard("Jogging", "Moderate", "/Jog.png"));
        add(Box.createVerticalStrut(15));
        add(createWorkoutCard("Inclined Walking", "Beginner", "/Hike.png"));
        ...
        unlockButton.addActionListener(e -> {
            JOptionPane.showMessageDialog(this, "Lose Weight workout selected!");
